...
class AuthController extends Controller
{
    ...
    public function systemverification(Request $request)
    {
        if( ini_get('allow_url_fopen') ) {
            ...
            $payload = file_get_contents('https://infotechgravity.com/api/getdata.php?envato_username='.$username.'&email='.$request->email.'&purchase_key='.$request->purchase_key.'&domain='.$request->domain.'&purchase_type=Envato&version=1');

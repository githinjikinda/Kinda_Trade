...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        <section id="basic-form-layouts">
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-header"><?php echo e(trans('labels.edit_bottombanner')); ?></div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <div class="px-3">
                                <form class="form" method="post" action="<?php echo e(route('admin.bottombanner.update')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="image"><?php echo e(trans('labels.image')); ?> (1200X600)</label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-actions center">
                                        <a href="<?php echo e(route('admin.bottombanner')); ?>" class="btn btn-raised btn-warning mr-1"><i class="ft-x"></i> <?php echo e(trans('labels.cancel')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u560359188/domains/kinda.africa/public_html/resources/views/Admin/bottombanner/show.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        <section id="basic-form-layouts">
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-header"><?php echo e(trans('labels.edit_innersubcategory')); ?></div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <div class="px-3">
                                <form class="form" method="post" action="<?php echo e(route('admin.innersubcategory.update')); ?>">
                                <?php echo csrf_field(); ?>
                                    <div class="form-body">
                                        <input type="hidden" name="inner_cat_id" id="inner_cat_id" value="<?php echo e($data->id); ?>" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cat_id" id="cat_id">
                                                ...
                                                <option value='<?php echo e($category->id); ?>' 
                                                  <?php echo e(($data->cat_id == $category->id) ? 'selected' : ''); ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="subcat_id" id="subcat_id">
                                                ...
                                                <option value='<?php echo e($subcategory->id); ?>' 
                                                  <?php echo e(($data->subcat_id == $subcategory->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="innersubcategory_name" class="form-control" name="innersubcategory_name" value="<?php echo e($data->innersubcategory_name); ?>" placeholder="<?php echo e(trans('placeholder.innersubcategory')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-actions center">
                                        <a href="<?php echo e(route('admin.innersubcategory')); ?>" class="btn btn-raised btn-warning mr-1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u560359188/domains/kinda.africa/public_html/resources/views/Admin/innersubcategory/show.blade.php ENDPATH**/ ?>
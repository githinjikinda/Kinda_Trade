<?php $__env->startSection('title'); ?>
    <?php echo e(Helper::webinfo()->site_title); ?> | <?php echo e(trans('labels.large_banner')); ?>
                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            <h4 class="card-title"><?php echo e(trans('labels.large_banner')); ?></h4>
                            <a href="<?php echo e(route('admin.largebanner.add')); ?>" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                <?php echo $__env->make('Admin.largebanner.largebannertable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function bannerTable() {
        $('#preloader').show();
        $.ajax({
            url:"<?php echo e(route('admin.largebanner.list')); ?>",
            method:'get',
        ...
        Swal.fire({
            ...
            if(t.value==true){
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route("admin.largebanner.changeStatus")); ?>',
                    type: "POST",
                    ...
                    { 
                        ...
                        {
                            Swal.fire({type: 'error',title: '<?php echo e(trans('labels.cancelled')); ?>',text: " Not change status", showConfirmButton: false,timer: 1500});
                        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u560359188/domains/kinda.africa/public_html/resources/views/Admin/largebanner/index.blade.php ENDPATH**/ ?>
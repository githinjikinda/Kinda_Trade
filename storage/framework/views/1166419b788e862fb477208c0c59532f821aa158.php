...
<!-- Single Item -->
<div class="col-3xl-2 col-xl-3 col-lg-4 col-sm-6 mb-4">
	<div class="woo_product_grid no-hover">

		<?php echo e($product->rattings_average); ?>
		...
		<a href="<?php echo e(URL::to('products/product-details/'.$product->slug)); ?>">
			<div class="woo_product_thumb">
				...
				?>
				<img src="<?php echo e($product['productimage']->image_url); ?>" class="img-fluid lazyload product-box-image <?php if($ext == 'png'): ?> gray-bg <?php endif; ?>" title="<?php echo e($product['product_name']); ?>" style="height: 335px; object-fit: scale-down; background-color: #f8f7f6;" />
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u560359188/domains/kinda.africa/public_html/resources/views/Front/categoryfilterproduct.blade.php ENDPATH**/ ?>
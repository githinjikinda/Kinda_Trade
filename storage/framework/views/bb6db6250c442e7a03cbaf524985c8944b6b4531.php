                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            <h4 class="card-title"><?php echo e(trans('labels.top_banner')); ?></h4>
                            <a href="<?php echo e(route('admin.banner.add')); ?>" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
...
<script type="text/javascript">
    ...
    function bannerTable() {
        $('#preloader').show();
        $.ajax({
            url:"<?php echo e(route('admin.banner.list')); ?>",
            method:'get',
        ...
        Swal.fire({
            ...
            if(t.value==true){
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route("admin.banner.changeStatus")); ?>',
                    type: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u560359188/domains/kinda.africa/public_html/resources/views/Admin/banner/index.blade.php ENDPATH**/ ?>
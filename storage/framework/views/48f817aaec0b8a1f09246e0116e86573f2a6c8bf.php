                    ...
                    <div style="font-family:'Lato',Helvetica,Arial,sans-serif;display:inline-block;margin:0px 0px 0 0;max-width:100%;width:100%;margin-right:0px">
                        ...
                        <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:20px 0 0px 0">
                            <div bgcolor="#f8f4e8" align="left"
                                 ...
                                 class="m_-7788511936867687679padding-copy">Dear <?php echo e($name); ?>,
                            </div>
                            ...
                            <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:15px 0 0px 0">
                                <div bgcolor="#f8f4e8" align="left"
                                    ...
                                    Somebody (hopefully you) requested a new password for the account for <?php echo e($email); ?> <br>Your new password is<b style="color: #fe724c;"> <?php echo e($password); ?></b><br>Kindly update your password after login. We'll be here to help you with any step along the way
...
<?php /**PATH /home/u560359188/domains/kinda.africa/public_html/resources/views/Email/email.blade.php ENDPATH**/ ?>
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="sec-heading-flex pl-2 pr-2">
						...
						<div class="sec-heading-flex-last">
							<a href="<?php echo e(URL::to('/featured-products')); ?>" class="btn btn-theme" style="background-color:#fcd340 ; border:#fcd340"><?php echo e(trans('labels.view_more')); ?><i class="ti-arrow-right ml-2"></i></a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="woo_product_cart hover">
							<ul>
								<?php if($product->is_wishlist == 1): ?>
									<li><a href="javascript:void();" onclick="RemoveWishList('<?php echo e($product->id); ?>','<?php echo e($product->product_name); ?>','<?php echo e(@Auth::user()->id); ?>')" class="woo_cart_btn btn_save" style="color:red"><?php echo e(trans('labels.wishlist')); ?> <i class="fas fa-heart i ml-2"></i></a></li>
								<?php else: ?>
								    <li><a href="javascript:void();" onclick="WishList('<?php echo e($product->id); ?>','<?php echo e($product->product_name); ?>','<?php echo e(@Auth::user()->id); ?>')" class="woo_cart_btn btn_save"style="color:red"><?php echo e(trans('labels.wishlist')); ?> <i class="ti-heart ml-2"></i></a></li>
								<?php endif; ?>
							</ul>
						</div>								
					</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="sec-heading-flex pl-2 pr-2">
						...
						<div class="sec-heading-flex-last">
							<a href="<?php echo e(URL::to('/hot-products')); ?>" class="btn btn-theme" style="background-color:#fcd340 ; border:#fcd340"><?php echo e(trans('labels.view_more')); ?><i class="ti-arrow-right ml-2"></i></a>
						</div>
					</div>
				</div>
			</div>
						...
						<a href="<?php echo e(URL::to('products/product-details/'.$product->slug)); ?>">
							...
							<div class="woo_product_caption">
								...
								<div class="woo_price mt-2">
									<h6 style="color: #fcd340" ><?php echo e(Helper::CurrencyFormatter($product->product_price)); ?><span class="less_price"><?php echo e(Helper::CurrencyFormatter($product->discounted_price)); ?></span></h6>
								</div>

								<?php if($product->product_price): ?>
									<span style="backgroud-color: #fcd340" class="post-article-cat theme-bg mt-2">Save <?php echo e(Helper::CurrencyFormatter($product->discounted_price - $product->product_price)); ?></span>
								<?php endif; ?>
							</div>
						</a>
						<div class="woo_product_cart hover">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="sec-heading-flex pl-2 pr-2">
						...
						<div class="sec-heading-flex-last">
							<a href="<?php echo e(URL::to('/new-products')); ?>" class="btn btn-theme" style="background-color:#fcd340 ; border:#fcd340"><?php echo e(trans('labels.view_more')); ?><i class="ti-arrow-right ml-2"></i></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="sec-heading-flex pl-2 pr-2">
						...
						<div class="sec-heading-flex-last">
							<a href="<?php echo e(URL::to('/all-brand')); ?>" class="btn btn-theme" style="background-color:#fcd340 ; border:#fcd340"><?php echo e(trans('labels.view_more')); ?><i class="ti-arrow-right ml-2"></i></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="sec-heading-flex pl-2 pr-2">
						...
						<div class="sec-heading-flex-last">
							<a href="<?php echo e(URL::to('/all-vendors')); ?>" class="btn btn-theme" style="background-color:#fcd340 ; border:#fcd340"><?php echo e(trans('labels.view_more')); ?><i class="ti-arrow-right ml-2"></i></a>
						</div>
					</div>
				</div>
			</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u560359188/domains/kinda.co.ke/public_html/resources/views/Front/home.blade.php ENDPATH**/ ?>
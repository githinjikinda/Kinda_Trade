<?php $__env->startSection('title'); ?>
    <?php echo e(Helper::webinfo()->site_title); ?>
							...
							<div class="toolbar toolbar-products">
								<div class="toolbar-sorter sorter">
									...
									<select id="sorter" data-role="sorter" class="sorter-options">
										<option selected value="search" data-type="search" data-item="<?php echo e(request()->item); ?>"><?php echo e(trans('labels.new_arrivals')); ?></option>
										<option value="price-high-to-low" data-type="search" data-item="<?php echo e(request()->item); ?>"><?php echo e(trans('labels.p_high_to_low')); ?></option>
										<option value="price-low-to-high" data-type="search" data-item="<?php echo e(request()->item); ?>"><?php echo e(trans('labels.p_low_to_high')); ?></option>
										<option value="ratting-high-to-low" data-type="search" data-item="<?php echo e(request()->item); ?>"><?php echo e(trans('labels.r_high_to_low')); ?></option>
										<option value="ratting-low-to-high" data-type="search" data-item="<?php echo e(request()->item); ?>"><?php echo e(trans('labels.r_low_to_high')); ?></option>
									</select>
								</div>
							</div>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u560359188/domains/kinda.africa/public_html/resources/views/Front/search.blade.php ENDPATH**/ ?>
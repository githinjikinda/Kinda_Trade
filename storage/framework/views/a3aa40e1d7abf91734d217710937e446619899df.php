...
<div class="header">
    ...
    <!-- Main header -->
    <div class="main_header" style = "background-color:#fcd340;">
        <div class="container">
                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-8">
                    ...
                    <div class="blocks shop_cart d-xl-none d-lg-none">
                        ...
                        <div class="single_shop_cart">
                            ...
                            <div style = "backround-color:black" class="ss_cart_content">
                                <strong style = "backround-color:black"><?php echo e(trans('labels.my_cart')); ?></strong>
                            </div>
                        </div>
                    </div>
...
<!-- ============================================================== -->
<!-- Top header  -->
<!-- ============================================================== --><?php /**PATH /home/u560359188/domains/kinda.co.ke/public_html/resources/views/includes/web/header.blade.php ENDPATH**/ ?>
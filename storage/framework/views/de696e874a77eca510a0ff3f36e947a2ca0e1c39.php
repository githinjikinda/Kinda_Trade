        ...
        <div class="col-lg-3 col-md-4">
          <div class="footer_widget">
            ...
            <div class="address_infos">
              <ul>
                <li><i style = "color:#fcd340 " class="ti-home theme-cl"></i><?php echo e(Helper::webinfo()->address); ?></li>
                <li><i style = "color:#fcd340 " class="ti-headphone-alt theme-cl"></i><?php echo e(Helper::webinfo()->contact); ?></li>
                <li><i style = "color:#fcd340 " class="ti-email theme-cl"></i><?php echo e(Helper::webinfo()->email); ?></li>
              </ul>
            </div>
...
<!-- ============================ Footer End ================================== -->
    ...
    <!-- End Wrapper -->
    <!-- ============================================================== -->
    <?php /**PATH /home/u560359188/domains/kinda.co.ke/public_html/resources/views/includes/web/footer.blade.php ENDPATH**/ ?>
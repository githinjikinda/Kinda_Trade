@extends('layouts.web')
@section('title')
    {{Helper::webinfo()->site_title}} | {{ trans('labels.featured_products') }}
@endsection
		...
		<div class="container">
			<nav aria-label="breadcrumb" class="simple_breadcrumbs">
			  <ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">{{ trans('labels.featured_products') }}</li>
			  </ol>
			</nav>
		</div>
	</div>
							...
							<div class="toolbar toolbar-products">
								<div class="toolbar-sorter sorter">
									...
									<select id="sorter" data-role="sorter" class="sorter-options">
										<option value="featured" selected="selected" data-type="featured">{{ trans('labels.featured') }}</option>
										<option value="new" data-type="featured">{{ trans('labels.new_arrivals') }}</option>
										<option value="price-high-to-low" data-type="featured">{{ trans('labels.p_high_to_low') }}</option>
										<option value="price-low-to-high" data-type="featured">{{ trans('labels.p_low_to_high') }}</option>
										<option value="ratting-high-to-low" data-type="featured">{{ trans('labels.r_high_to_low') }}</option>
										<option value="ratting-low-to-high" data-type="featured">{{ trans('labels.r_low_to_high') }}</option>
									</select>
								</div>
							</div>
						</div>

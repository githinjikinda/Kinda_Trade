                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            <h4 class="card-title">{{ trans('labels.bottom_banner') }}</h4>
                            <a href="{{route('admin.bottombanner.add')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                    @include('Admin.bottombanner.bottombannertable')
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function bannerTable() {
        $('#preloader').show();
        $.ajax({
            url:"{{ route('admin.bottombanner.list') }}",
            method:'get',
        ...
        Swal.fire({
            ...
            if(t.value==true){
                ...
                $.ajax({
                    ...
                    url: '{{route("admin.bottombanner.changeStatus")}}',
                    type: "POST",
                    ...
                    { 
                        ...
                        if(data == 1000)
                        {
                            Swal.fire({type: 'success',title: "{{ trans('labels.sucess') }}",showConfirmButton: false,timer: 1500});    
                            if(status=='1'){

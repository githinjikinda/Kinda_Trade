                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            <h4 class="card-title">{{ trans('labels.left_banner') }}</h4>
                            <a href="{{route('admin.leftbanner.add')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                    @include('Admin.leftbanner.leftbannertable')
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function bannerTable() {
        $('#preloader').show();
        $.ajax({
            url:"{{ route('admin.leftbanner.list') }}",
            method:'get',
        ...
        Swal.fire({
            ...
            if(t.value==true){
                ...
                $.ajax({
                    ...
                    url: '{{route("admin.leftbanner.changeStatus")}}',
                    type: "POST",

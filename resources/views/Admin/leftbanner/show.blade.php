...
@section('title')
    {{Helper::webinfo()->site_title}} | {{ trans('labels.left_banner') }}
@endsection
@section('css')
...
@section('content')
    <div class="content-wrapper">
        <section id="basic-form-layouts">
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-header">{{ trans('labels.edit_leftbanner') }}</div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <div class="px-3">
                                <form class="form" method="post" action="{{ route('admin.leftbanner.update') }}" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="image">{{ trans('labels.image') }} (1200X800)</label>
                                    ...
                                    <div class="form-actions center">
                                        <a href="{{ route('admin.leftbanner') }}" class="btn btn-raised btn-warning mr-1">

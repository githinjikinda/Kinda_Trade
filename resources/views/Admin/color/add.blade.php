...
@section('content')
    <div class="content-wrapper">
        <section id="basic-form-layouts">
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-header">{{ trans('labels.add_color') }}</div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <div class="px-3">
                                <form class="form" method="post" action="{{ route('admin.color.store') }}" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-body">

                                        <div class="form-group">
                                            <label for="color_name">{{ trans('labels.select_color') }}</label>
                                            <input type="color" class="form-control" name="color_name" id="color_name" style="height: 50px;">

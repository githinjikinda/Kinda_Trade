                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label>{{ trans('labels.Privacy_Policy') }}</label>
                                                <textarea class="form-control" name="privacypolicy_content" id="privacypolicy_content" rows="6" placeholder="{{ trans('labels.Privacy_Policy') }}">{{$data->privacypolicy_content}}</textarea>
                                                @error('privacypolicy_content')<span class="text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>
                                    </div>

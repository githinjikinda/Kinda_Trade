...
@section('content')
    <div class="content-wrapper">
        <section id="basic-form-layouts">
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-header">{{ trans('labels.edit_largebanner') }}</div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <div class="px-3">
                                <form class="form" method="post" action="{{ route('admin.largebanner.update') }}" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-body">
                                    ...
                                    <div class="form-actions center">
                                        <a href="{{ route('admin.largebanner') }}" class="btn btn-raised btn-warning mr-1">
